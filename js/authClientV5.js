...
export async function signInGitHub(){const c=await getAuthClient();const {data,error}=await c.auth.signInWithOAuth({provider:'github',options:{redirectTo:site('dashboard.html')}});if(error)throw error;return data}
